...
public class Solution
{
    ...
    static class Matrix
    {
        public static DBObject NEO = new User().initializeIdAndName(1, "Neo"); // опять полиморфизм,
        // попробовать самому где-то использовать такое в андроид тасках для проекта

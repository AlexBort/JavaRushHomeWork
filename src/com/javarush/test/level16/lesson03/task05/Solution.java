...
/*public class Solution
{
    ...
    public static class Violin extends Thread implements MusicalInstrument
    {
        private String owner;
        ...
        public void run()
        {
            ...
            startPlaying();
            date_start = startPlaying();
            sleepNSeconds(1);
            Date date_stop = new Date();

            stopPlaying();
            date_stop = stopPlaying();
            long result = stopPlaying().getTime() - startPlaying().getTime();

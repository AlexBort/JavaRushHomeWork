...
public class Solution
{
    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        firstThread.start();
        firstThread.join(); // все, я понял, тоесть сначала стартанул first_thread, он запустился,
        // и метод join () дает возможность дождаться, пока полностью этот thread завершится, а потом уже приступить к следующему
        secondThread.start();

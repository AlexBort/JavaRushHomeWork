...
// когда мы прописали метод join() для alpha, мы тем самым произвели следующий момент: пока этот объект не выполнит свою работу,
// другие объекты ничего не смогут сделать

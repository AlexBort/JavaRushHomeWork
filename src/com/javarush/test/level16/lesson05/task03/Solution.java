...
public class Solution {
    ...
    public static int totalCountSpeeches = 200; // общий счетчик разговоров
    public static int soundsInOneSpeech = 1000000; // звуков в одной речи ?!?!

    public static void main(String[] args) throws InterruptedException { // Main-овый поток
    ...
    public static class Politic extends Thread { // класс унаследованный от Thread-a
